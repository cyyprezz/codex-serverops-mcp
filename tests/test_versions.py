...
class VersionContractTests(unittest.TestCase):
    def test_spike_versions_are_explicit_positive_integers(self) -> None:
        self.assertEqual(codex_serverops_mcp.PACKAGE_VERSION, "0.0.0.dev1")
        expected = {
            "broker": (codex_serverops_mcp.BROKER_PROTOCOL_VERSION, 2),
            "worker": (codex_serverops_mcp.WORKER_PROTOCOL_VERSION, 2),
